ActionController::Routing::Routes.draw do |map|
  ...
  map.resource :gadgets, :only => [], :member => {:gapps_calenders => :post, :gapps_mails => :post, :tenpo_notices => :post, :skip_questions => :post, :skip_notices => :post, :infoscoop_header => :any, :skip_recents => :get}
